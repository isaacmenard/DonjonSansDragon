if (selectMap == 40) {
    ...
    setTimeout(() => {
        ...
        cercleTpCrea("5 0 5")
        pnjCreation(5, 5, "", "hidden", "Où souhaitez-vous aller ?<p class='rep' onclick='openWin(\"monde.php?map=11\");closeWinMonde()'> Sur terre ? </p><p class='rep'  onclick='openWin(\"monde.php?map=41\");closeWinMonde()'>Dans la citée sous Marine ?</p>",0)
